	...
	SubShader {   
		...
		Blend SrcAlpha  OneMinusSrcAlpha   
			...
			float4 frag (v2f i) : COLOR {
				...
				uv_alpha1 = uv_alpha1+center_alpha1;    
				float4 color_alpha1 = tex2D(_wave_9612,uv_alpha1);    
